...
import { toggleStickySidebar, toggleSidebar } from '../../redux/actions/sidebarActions';

import { enableClassicTheme, enableCorporateTheme, enableModernTheme } from '../../redux/actions/themeActions';
            ...
            <PerfectScrollbar>
                ...
                <ul className="settings-layouts">
                  <li>
                    <span
                      ...
                      onClick={() => dispatch(toggleStickySidebar(), this.toggleSidebar())}
                    >
                  ...
                  <li>
                    <span
                      className="settings-layouts-item"
                      onClick={() => dispatch(toggleBoxedLayout(), this.toggleSidebar())}
                    >
              ...
              <div className="settings-section">
                ...
                <div
                  ...
                  onClick={() => dispatch(enableClassicTheme(), this.toggleSidebar())}
                >
                  <img
                ...
                <div
                  className="settings-theme"
                  onClick={() => dispatch(enableCorporateTheme(), this.toggleSidebar())}
                >
                  <img
                ...
                <div
                  className="settings-theme"
                  onClick={() => dispatch(enableModernTheme(), this.toggleSidebar())}
                >
                  <img
