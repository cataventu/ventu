  ...
  return (
    <>
      <Container fluid className="p-0 ">
        ...
        />
      <Card id="dashboard-pfisica" className={`p-3 filter `}>
...
const mapState = (state) => ({
 ...
 serie: state.pFisica.dashboardListaData,
 rotulo: state.pFisica.dashboardListaData,
 valor: state.pFisica.dashboardListaData,
 dado_regs: state.pFisica.dashboardListaData,
 serie_regs: state.pFisica.dashboardListaData,
 pagina: state.pFisica.dashboardListaData,
 dashboardListaData: state.pFisica.dashboardListaData,
