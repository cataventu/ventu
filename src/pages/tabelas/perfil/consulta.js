...
import { getConsultaPerfil } from '../../../functions/tabelas/perfil';

///////// PERFIL ///////////////
//////////////////////////////
function PerfilConsulta(props) {
...
const mapState = (state) => ({
  perfilConsulta: state.perfil.perfilConsulta,

  auth: state.sistema.auth,
});
export default connect(() => (mapState))(PerfilConsulta);
