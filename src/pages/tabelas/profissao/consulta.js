...
import { getConsultaProfissao } from '../../../functions/tabelas/profissao';
import { formatData, formatSituacao } from '../../../functions/sistema';

///////// PROFISSAO ///////////////
//////////////////////////////
function ProfissaoConsulta(props) {
      ...
      <Container fluid className="p-0 ">
        ...
        <Card className="p-3">
          <div className="consulta-body">
            <ConsultaHeader titulo="Profissão" />
...
const mapState = (state) => ({
  profissaoConsulta: state.profissao.profissaoConsulta,

  auth: state.sistema.auth,
});
export default connect(() => (mapState))(ProfissaoConsulta);
